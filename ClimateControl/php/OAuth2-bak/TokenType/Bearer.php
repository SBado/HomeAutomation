...
class Bearer implements TokenTypeInterface
{
    ...
    public function getAccessTokenParameter(RequestInterface $request, ResponseInterface $response)
    {
         ...
         */
        error_log('OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO');
        error_log(print_r($headers, true));
        error_log(print_r(!empty($headers), true));
		error_log(print_r($request, true));
		error_log(print_r($request->query($this->config['token_param_name']), true));        
		error_log(print_r($request->request($this->config['token_param_name']), true));
